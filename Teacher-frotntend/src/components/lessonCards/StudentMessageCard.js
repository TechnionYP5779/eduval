          ...
          <CardContent className={classes.content}>
            <Row>
              <Col className={classes.columns}>
                  ...
                  ,
                    {
                      ...
                      [classes.disabled]: this.props.count_questions()==0
                    }
                )}
                onClick={()=>
                {
                ...
                disabled={this.props.count_questions()==0}
                >
                  <HelpIcon />
                  <br/>
                  {t("Questions")}
              ...
              <Col className={classes.columns}>
                  ...
                  ,
                    {
                      ...
                      [classes.disabled]: this.props.count_go_out()==0
                    }
                )}
                onClick={()=>
                {
                ...
                disabled={this.props.count_go_out()==0}
              ...
              <Col className={classes.columns}>
                  ...
                  ,
                    {
                      ...
                      [classes.disabled]: this.props.count_answer()==0
                    }
                )}
                onClick={()=>
                {
                ...
                disabled={this.props.count_answer()==0}
                >
                  <RecordVoiceOverIcon  />
                  <br/>
                  {t("Answer")+"!"}
              ...
              <Col className={classes.columns}>
                  ...
                  ,
                    {
                      ...
                      [classes.disabled]: this.props.count_confused()==0
                ...
                disabled={this.props.count_confused()==0}
              ...
              <Col className={classes.columns}>
                  ...
                  ,
                    {
                      ...
                      [classes.disabled]: this.props.count_louder()==0
                    }
                )}
                onClick={()=>
                  {
                ...
                disabled={this.props.count_louder()==0}
                >
                  <VolumeUpIcon  />
                  <br/>
                  {t("Louder")}
